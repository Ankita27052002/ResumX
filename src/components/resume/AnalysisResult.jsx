        ...
        <div className="p-6">
          ...
          <div className="border-b border-gray-200 mb-6">
            <nav className="-mb-px flex space-x-8">
              <a href="#analysis" className="border-indigo-500 text-indigo-600 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                Analysis
              </a>
              <a href="#profile" className="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                Resume Profile
              </a>
              <a href="#recommendations" className="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
          ...
          <div id="analysis" className="prose max-w-none">
            {analysis && (
